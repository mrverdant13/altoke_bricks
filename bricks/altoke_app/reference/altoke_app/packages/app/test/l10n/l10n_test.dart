...
void main() {
  group('AppLocalizations', () {
    test(
      'should have a localized value for each supported locale',
      () async {
        ...
        expect(
          ...
          isNotNull,
          reason: 'The "untranslated-messages-file" key '
        ...
        final untranslatedMessages = jsonDecode(
          untranslatedMessagesFile.readAsStringSync(),
