...
| `android_application_identifier` | The application identifier for the Android project. | _None_ | String |
| `ios_bundle_identifier` | The bundle identifier for the iOS project. | _None_ | String |
| `macos_bundle_identifier` | The bundle identifier for the macOS project. | _None_ | String |
