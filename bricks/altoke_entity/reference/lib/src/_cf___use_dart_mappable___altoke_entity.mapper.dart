...
class DmAltokeEntityMapper extends ClassMapperBase<DmAltokeEntity> {
  ...
  static DmAltokeEntity fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<DmAltokeEntity>(map);
  }

  static DmAltokeEntity fromJson(String json) {
    return ensureInitialized().decodeJson<DmAltokeEntity>(json);
  }
}
...
mixin DmAltokeEntityMappable {
  String toJson() {
    return DmAltokeEntityMapper.ensureInitialized()
        .encodeJson<DmAltokeEntity>(this as DmAltokeEntity);
  }

  Map<String, dynamic> toMap() {
    return DmAltokeEntityMapper.ensureInitialized()
        .encodeMap<DmAltokeEntity>(this as DmAltokeEntity);
  }
...
class DmNewAltokeEntityMapper extends ClassMapperBase<DmNewAltokeEntity> {
  ...
  static String _$title(DmNewAltokeEntity v) => v.title;
  static const Field<DmNewAltokeEntity, String> _f$title =
      Field('title', _$title);
  ...
  static DmNewAltokeEntity fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<DmNewAltokeEntity>(map);
  }

  static DmNewAltokeEntity fromJson(String json) {
    return ensureInitialized().decodeJson<DmNewAltokeEntity>(json);
  }
}
...
mixin DmNewAltokeEntityMappable {
  String toJson() {
    return DmNewAltokeEntityMapper.ensureInitialized()
        .encodeJson<DmNewAltokeEntity>(this as DmNewAltokeEntity);
  }

  Map<String, dynamic> toMap() {
    return DmNewAltokeEntityMapper.ensureInitialized()
        .encodeMap<DmNewAltokeEntity>(this as DmNewAltokeEntity);
  }
...
class DmPartialAltokeEntityMapper
  ...
  static DmOptional<String> _$description(DmPartialAltokeEntity v) =>
      v.description;
  static const Field<DmPartialAltokeEntity, DmOptional<String>> _f$description =
      Field('description', _$description,
  ...
  static DmPartialAltokeEntity fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<DmPartialAltokeEntity>(map);
  }

  static DmPartialAltokeEntity fromJson(String json) {
    return ensureInitialized().decodeJson<DmPartialAltokeEntity>(json);
  }
}
...
mixin DmPartialAltokeEntityMappable {
  String toJson() {
    return DmPartialAltokeEntityMapper.ensureInitialized()
        .encodeJson<DmPartialAltokeEntity>(this as DmPartialAltokeEntity);
  }

  Map<String, dynamic> toMap() {
    return DmPartialAltokeEntityMapper.ensureInitialized()
        .encodeMap<DmPartialAltokeEntity>(this as DmPartialAltokeEntity);
  }
