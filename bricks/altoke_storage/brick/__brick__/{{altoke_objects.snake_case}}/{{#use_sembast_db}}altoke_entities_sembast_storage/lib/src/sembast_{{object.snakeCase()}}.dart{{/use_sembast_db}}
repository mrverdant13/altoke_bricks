...
/// {@template altoke_entities_sembast_storage.sembast_{{object.snakeCase()}}}
/// A Sembast representation of an Altoke Entity.
/// {@endtemplate}
@JsonSerializable()
class SembastAltokeEntity {
  /// {@macro altoke_entities_sembast_storage.sembast_{{object.snakeCase()}}}
...
/// {@template altoke_entities_sembast_storage.sembast_partial_{{object.snakeCase()}}}
/// A Sembast representation of a partial Altoke Entity.
/// {@endtemplate}
class SembastPartialAltokeEntity {
  /// {@macro altoke_entities_sembast_storage.sembast_partial_{{object.snakeCase()}}}
