...
''',
    () async {
      ...
      final storage = {{objects.pascalCase()}}IsarStorage(database: database);
...
├─ THAT uses an Isar database''',
    () {
      ...
      late Isar database;
      late {{objects.pascalCase()}}IsarStorage storage;
      late Isar{{objects.pascalCase()}}Collection isar{{objects.pascalCase()}};
      ...
      setUp(() async {
        ...
        storage = {{objects.pascalCase()}}IsarStorage(database: database);
        isar{{objects.pascalCase()}} = database.isar{{objects.pascalCase()}};
      });
...
''',
        () async {
          ...
          final existing{{objects.pascalCase()}}Count = await isar{{objects.pascalCase()}}.count();
          expect(existing{{objects.pascalCase()}}Count, isZero);
          await storage.create(new{{object.pascalCase()}}: new{{object.pascalCase()}});
          final resultingMatching{{objects.pascalCase()}}Count = await isar{{objects.pascalCase()}}
              .filter()
              .nameEqualTo(new{{object.pascalCase()}}.name)
              .descriptionEqualTo(new{{object.pascalCase()}}.description)
              .count();
          expect(
...
''',
        () async {
          ...
          await database.writeTxn(
            () async => isar{{objects.pascalCase()}}.put(
              existing{{object.pascalCase()}}.toIsar(),
            ),
          );
          final initial{{objects.pascalCase()}}Count = await isar{{objects.pascalCase()}}.count();
...
''',
        () async {
          ...
          final resulting{{objects.pascalCase()}}Count = await isar{{objects.pascalCase()}}.count();
...
''',
        () async {
          ...
          await database.writeTxn(
            () async => isar{{objects.pascalCase()}}.put(
              new{{object.pascalCase()}}.toIsar()..id = {{object.camelCase()}}Id,
            ),
          );
          final initialMatching{{objects.pascalCase()}}Count = await isar{{objects.pascalCase()}}
              .filter()
              .idEqualTo({{object.camelCase()}}Id)
              .count();
...
''',
        () async {
          ...
          final initial{{objects.pascalCase()}} =
              await isar{{objects.pascalCase()}}.where().findAll();
...
''',
        () async {
          ...
          await database.writeTxn(
            () async => isar{{objects.pascalCase()}}.putAll([
              for (final {{object.camelCase()}} in {{objects.camelCase()}}) {{object.camelCase()}}.toIsar(),
            ]),
          );
          final initial{{objects.pascalCase()}}Count = await isar{{objects.pascalCase()}}.count();
          ...
          final resultingIsar{{objects.pascalCase()}} =
              await isar{{objects.pascalCase()}}.where().findAll();
          ...
          expect(
            resultingIsar{{objects.pascalCase()}},
            hasLength(expectedResulting{{objects.pascalCase()}}.length),
          );
          final resulting{{objects.pascalCase()}} = [
            for (final isar{{object.pascalCase()}} in resultingIsar{{objects.pascalCase()}})
              isar{{object.pascalCase()}}.to{{object.pascalCase()}}(),
          ];
          expect(
...
''',
        () async {
          ...
          final resultingIsar{{objects.pascalCase()}}Count =
              await isar{{objects.pascalCase()}}.count();
          expect(resultingIsar{{objects.pascalCase()}}Count, isZero);
        },
      );
...
''',
        () async {
          ...
          final resultingIsar{{objects.pascalCase()}} =
              await isar{{objects.pascalCase()}}.where().findAll();
          expect(resultingIsar{{objects.pascalCase()}}, hasLength(1));
          final resultingIsar{{object.pascalCase()}} = resultingIsar{{objects.pascalCase()}}.single;
          expect(resultingIsar{{object.pascalCase()}}.to{{object.pascalCase()}}(), {{object.camelCase()}});
        },
      );
...
''',
        () async {
          ...
          await database.writeTxn(
            () async => isar{{objects.pascalCase()}}.put({{object.camelCase()}}.toIsar()),
          );
          final existing{{objects.pascalCase()}}Count = await isar{{objects.pascalCase()}}.count();
          expect(existing{{objects.pascalCase()}}Count, 1);
          const newTitle = 'new name';
          const newDescription = 'new description';
          final query = isar{{objects.pascalCase()}}
              .filter()
              .idEqualTo({{object.camelCase()}}.id)
              .and()
          ...
          final existingMatching{{objects.pascalCase()}}Count = await query.count();
          ...
          final resultingMatching{{objects.pascalCase()}}Count = await query.count();
          expect(
            resultingMatching{{objects.pascalCase()}}Count,
...
''',
        () async {
          ...
          final query = isar{{objects.pascalCase()}}.filter().idEqualTo({{object.camelCase()}}Id);
          final initialMatching{{objects.pascalCase()}}Count = await query.count();
          expect(initialMatching{{objects.pascalCase()}}Count, 1);
...
''',
        () async {
          ...
          await database.writeTxn(
            () async => isar{{objects.pascalCase()}}.put(
              new{{object.pascalCase()}}InStage01.toIsar(),
            ),
          );
          ...
          await database.writeTxn(
            () async =>
                isar{{objects.pascalCase()}}.filter().nameContains('01').deleteAll(),
          );

          // Stage 03
          await database.writeTxn(
            () async {
              final {{objects.camelCase()}}WithoutDescription = await isar{{objects.pascalCase()}}
                  .filter()
                  .descriptionIsNull()
                  .findAll();
              await isar{{objects.pascalCase()}}.putAll([
                for (final {{object.camelCase()}} in {{objects.camelCase()}}WithoutDescription)
