    ...
    return AbsorbPointer(
      ...
      child: DismissibleWrapper(
        child: BaseTaskTile(
          ...
          onTap: () {
            final taskId = ref.read(taskPod).id;{{#use_auto_route_router}}context.navigateTo(TaskDetailsRoute(taskId: taskId));{{/use_auto_route_router}}{{#use_go_router_router}}TaskDetailsRouteData(taskId: taskId).go(context);{{/use_go_router_router}}
},
        ),
      ),
    );
