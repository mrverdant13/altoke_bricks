...
2. Applies `brick-gen.json` content replacements, then prompts for every variable in `brick/brick.yaml` plus any Mustache variables referenced in the transformed file or `brick-gen.json`
