...
/// {@template brick_scope_clay_config_not_found_error}
/// Error thrown when the brick scope Clay config file is not found.
/// {@endtemplate}
class BrickScopeClayConfigNotFoundError extends InvalidBrickScopeDirError {
  /// {@macro brick_scope_clay_config_not_found_error}
  const BrickScopeClayConfigNotFoundError({required String clayConfigPath})
    : super('Clay config file not found ($clayConfigPath).');
}
