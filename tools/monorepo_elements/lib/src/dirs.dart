...
abstract final class Dirs {
  ...
  static final Directory package = () {
  ...
  static final Directory e2eTest = () {
  ...
  static final Directory brickTemplate = () {
